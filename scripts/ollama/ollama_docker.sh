...
# * Description       : <Setup Ollama, ROCm, and OpenWeb UI>
# *                    
# * Revision History  :
# * Date		Author 			Comments
# * ------------------------------------------------------------------
# * 11/17/2024	<iCarlosMendez>	<Insprired by ChatGPT>
# *
# * /******************************************************************/
...
# ##################################################### #
# Install barebones Ollama on Linux
...
# Install Open WebUI running alone in a Docker container.
# docker run -d -p 3000:8080 --add-host=host.docker.internal:host-gateway -v open-webui:/app/backend/data --name open-webui --restart always ghcr.io/open-webui/open-webui:main
# Used when Ollama is installed on the Docker host.

# Or this alternative when you have issues connecting to ollama, which I seem to. I use this one.
docker run -d --network=host -v open-webui:/app/backend/data -e OLLAMA_BASE_URL=http://127.0.0.1:11434 --name open-webui --restart always ghcr.io/open-webui/open-webui:main
# Used when Ollama is installed on the Docker host.


# ##################################################### #
# Pull 22.04 image from Docker Hub
sudo docker pull rocm/dev-ubuntu-22.04:6.2.4-complete

# Install ROCm running alone in a container.
# Paired with 22.04 because that's the image I pulled from Docker Hub 
sudo docker run --device /dev/kfd --device /dev/dri --security-opt seccomp=unconfined rocm/dev-ubuntu-22.04:6.2.4-complete
